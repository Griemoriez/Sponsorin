...
class profile_company2 extends StatefulWidget {
  const profile_company2({super.key});

  @override
  State<profile_company2> createState() => _profile_company2State();
}

class _profile_company2State extends State<profile_company2>
